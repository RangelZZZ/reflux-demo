...
/***/ function(module, exports, __webpack_require__) {
	...
	var action = _reflux2.default.createActions(["getValue"]);
	
	var stores = _reflux2.default.createStore({
	
	    listenables: [action],
	    onGetValue: function onGetValue(value) {
	        this.trigger(value);
	    }
	});
	...
	var Left = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            "div",
	            null,
	            _react2.default.createElement("input", { type: "text", ref: "myInput", onChange: this.handleChange })
	        );
	    }
	...
	var Right = _react2.default.createClass({
	    ...
	    mixins: [_reflux2.default.connect(stores, "value")],
